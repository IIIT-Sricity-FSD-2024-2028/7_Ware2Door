...
export class ScanRepository {
    private hubScanHistoryPath    = join(process.cwd(), 'src', 'scan', 'hub-scan-history.json');
    private agencyScanHistoryPath = join(process.cwd(), 'src', 'scan', 'agency-scan-history.json');
    ...
    private driversPath           = join(process.cwd(), 'src', 'workers', 'drivers.json');

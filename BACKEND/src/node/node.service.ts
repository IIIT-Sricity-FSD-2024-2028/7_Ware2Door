...
export class NodeService {
    ...
    async addPendingShipment(warehouseId: string, body: any, thirdParty?: { id: string; name: string; tier: string }) {
        const shipment = {
            ...
            ...(thirdParty ? { thirdPartyId: thirdParty.id, thirdPartyName: thirdParty.name, thirdPartyTier: thirdParty.tier } : {}),
        };
